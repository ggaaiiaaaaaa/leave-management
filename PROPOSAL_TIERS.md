...
```mermaid
graph TD
    A[Present Tier 1 Live Mockup] --> B[Show ₱50k Base Value: Zero Paperwork, DOLE Compliant]
    B --> C[Introduce Pain Point: 'What happens during peak BIR Tax Season?']
    C --> D[Pitch Tier 2 ₱70k Sweet Spot: Automated Blackout Windows & 2-Tier Partner Approval]
    D --> E[Introduce Payroll Pain Point: 'How does HR pass leave deductions to payroll?']
    E --> F[Close Tier 3 ₱85k: Full Payroll Ready Export + Viber/Teams Alerts + 3-Mo SLA Warranty]
```
